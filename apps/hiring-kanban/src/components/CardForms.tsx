...
import { notEmpty, base64toBlob, useMobileDetect } from '@juxt-home/utils';
...
type AddHiringCardInput = CreateHiringCardMutationVariables & {
  project: Option;
  workflowState: Option;
};

type AddHiringCardModalProps = ModalStateProps;
...
export function AddHiringCardModal({
  ...
  }, [workflowProjectId, label, formHooks]);
  return (
...
type UpdateHiringCardInput = UpdateHiringCardMutationVariables & {
  project: Option;
  workflowState: Option;
};
...
export function HiringCardModal({ isOpen, handleClose }: CardModalProps) {
